...
{
    class agDateTimeColumn : DateTimePicker, IDataGridViewEditingControl
    {

        private DataGridView grid;
        private bool valueChanged;

        public agDateTimeColumn()
        {
    ...
    public class DateTimeCell : DataGridViewTextBoxCell
    {
        ...
        {
            get { return typeof(agDateTimeColumn); }
        }
        ...
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            agDateTimeColumn ctl = DataGridView.EditingControl as agDateTimeColumn;
            try
            {
                if (this.Value == null)
